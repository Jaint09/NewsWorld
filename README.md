...
- 📂 Browse news by category (Technology, Sports, Business, etc.)  
- 🌓 Light/Dark mode toggle with theme persistence  
- 🖱️ Clickable news cards that redirect to the full article  
...
## Setup Instructions
1. Clone the repo  
2. Get a free API key from [NewsAPI](https://newsapi.org/register)  
